...
void WalletModel::unsubscribeFromCoreSignals()
{
    ...
    wallet->NotifyStatusChanged.disconnect(connNotifyStatusChanged);
    wallet->NotifyAddressBookChanged.disconnect(connNotifyAddressBookChanged);
    wallet->NotifyTransactionChanged.disconnect(connNotifyTransactionChanged);
}
