...
/** Sanity checks
 *  Ensure that Version is running in a usable environment with all
...
bool AppInit2()
{
    ...
    // Sanity check
    if (!InitSanityCheck())
        return InitError(_("Elliptic curve cryptography sanity check failed. Version is shutting down."));
